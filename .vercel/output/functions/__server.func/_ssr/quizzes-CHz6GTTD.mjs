//#region node_modules/.nitro/vite/services/ssr/assets/quizzes-CHz6GTTD.js
var QUIZZES = [
	{
		slug: "fractions",
...
function scoreQuiz(quiz, picks) {
	const correct = quiz.questions.reduce((sum, q, i) => sum + (picks[i] === q.answer ? 1 : 0), 0);
	return Math.round(correct / quiz.questions.length * 100);
}
//#endregion
export { getQuiz as n, scoreQuiz as r, QUIZZES as t };
